...
class Subsession(BaseSubsession):
    def creating_session(self):
        error = np.random.randn(1,3) # calc
    ...
    def get_weather(self):
        p, q = divmod(self.round_number-1, 3) # calc
    ...
    def get_weather_forecast_afters(self):
        p, q = divmod(self.round_number, 3) # calc
        return self.session.vars['weather_forecast'][p][q:]
